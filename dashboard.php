...
<div class="container mx-auto px-6 py-12">
    ...
    <div class="flex flex-col md:flex-row items-center justify-between">
        ...
        <div class="md:w-1/2" data-aos="fade-right" data-aos-delay="500">
            <h1 class="text-4xl font-bold text-white mb-4">Sistem Manajemen Pengelolaan Sampah</h1>
            ...
            <a href="input_sampah.php"
                class="bg-white text-black px-6 py-2 rounded-lg hover:bg-green-100 transition duration-300 hover:scale-105">Mulai
                Sekarang</a>
    ...
    <!-- Fitur Utama -->
    <div class="mt-12">
        <h2 class="text-3xl font-bold text-center text-white mb-6" data-aos="fade-up">Fitur Utama</h2>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <!-- Fitur 1 -->
            <div class="bg-white p-6 rounded-lg shadow-lg text-center transition duration-300 hover:scale-105"
                data-aos="zoom-in">
                <h3 class="text-xl font-semibold text-gray-700 mb-2">Input Sampah</h3>
            ...
            <div class="bg-white p-6 rounded-lg shadow-lg text-center" data-aos="zoom-in" data-aos-delay="200">
                <h3 class="text-xl font-semibold text-gray-700 mb-2">Data Nasabah</h3>
            ...
            <div class="bg-white p-6 rounded-lg shadow-lg text-center" data-aos="zoom-in" data-aos-delay="400">
                <h3 class="text-xl font-semibold text-gray-700 mb-2">Laporan dan Statistik</h3>
