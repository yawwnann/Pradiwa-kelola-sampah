...
<div
    class="container mx-auto px-4 sm:px-6 lg:px-8 min-w-screen py-12 pt-20 bg-gradient-to-r from-emerald-600 to-teal-700">
    <!-- Section Gambar dan Deskripsi -->
    <div class="flex flex-col md:flex-row items-center justify-between gap-8">
        <!-- Deskripsi -->
        <div class="md:w-1/2 text-center md:text-left" data-aos="fade-right" data-aos-delay="500">
            <h1 class="text-3xl sm:text-4xl font-bold text-gray-50 mb-4">Sistem Manajemen Pengelolaan Sampah</h1>
            ...
            <a href="input_sampah.php"
                class="bg-gray-50 text-black px-6 py-2 rounded-lg hover:bg-green-100 transition duration-300 hover:scale-105 inline-block">Mulai
                Sekarang</a>
        </div>
        ...
        <div class="md:w-1/2 flex justify-center" data-aos="fade-left" data-aos-delay="500">
            <img src="asset/sampah_dashboard.png" alt="Pengelolaan Sampah"
                class="w-full max-w-md sm:max-w-lg transition-transform duration-300 hover:scale-105">
        </div>
    </div>
